...
public class AssetMetadata {
	...
	private BigInteger spotMoving24HourQuoteVolumeTopTierDirectUsd;

	@JsonProperty("SPOT_MOVING_24_HOUR_QUOTE_VOLUME_DIRECT_USD")
	private BigInteger spotMoving24HourQuoteVolumeDirectUsd;

	@JsonProperty("SPOT_MOVING_24_HOUR_QUOTE_VOLUME_TOP_TIER_USD")
	private BigInteger spotMoving24HourQuoteVolumeTopTierUsd;

	@JsonProperty("SPOT_MOVING_24_HOUR_QUOTE_VOLUME_USD")
	private BigInteger spotMoving24HourQuoteVolumeUsd;

	@JsonProperty("SPOT_MOVING_24_HOUR_CHANGE_USD")
	private BigInteger spotMoving24HourChangeUsd;
